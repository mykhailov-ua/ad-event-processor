...
from scoring_policy import action_fraud_positive, decide
from shadow_precision import run_shadow_precision
from traffic_simulator import ARCHETYPES, generate_network_batch
...
def _load_booster(model_path: Path):
    try:
        ...
        raise SystemExit(
            "evaluate: lightgbm required — pip install -r fraud_modeling/requirements.txt"
        ) from exc
