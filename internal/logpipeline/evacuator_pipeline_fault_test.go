...
func TestFault_logEvacuatorWaitsForCompactorMarker(t *testing.T) {
	logDir := t.TempDir()
	...
	markerPath := CompactMarkerPath(logDir, filepath.Base(readyPath))
	...
	faultproof.Log(t, "log_evacuator_waits_for_compactor_marker", map[string]string{
