...
// TestChaos_RegionGlobalPGPartition is CH-MR-10: global PG outage blocks uplink apply; heal drains once.
func TestChaos_RegionGlobalPGPartition(t *testing.T) {
	if testing.Short() {
	...
	logChaosProof(t, "mr_global_pg_partition", map[string]string{
