...
// TestChaos_GlobalSpendReconciler verifies cross-region spend batches preserve budget invariant after replay.
func TestChaos_GlobalSpendReconciler(t *testing.T) {
	if testing.Short() {
	...
	logChaosProof(t, "mr_global_spend_reconciler", map[string]string{
