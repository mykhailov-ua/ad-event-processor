...
// TestChaos_ProxyKeyGenCPUThrottle is CH-MR-05: throttled derive and TierLow shed must not duplicate factor_u.
func TestChaos_ProxyKeyGenCPUThrottle(t *testing.T) {
	t.Parallel()
	...
	logChaosProof(t, "mr_keygen_throttle", map[string]string{
