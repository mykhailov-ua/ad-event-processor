...
// TestChaos_CTVGtaxSettlementReplay verifies idempotent CTV gtax settlement and budget invariant (GAP-RTB-12a).
func TestChaos_CTVGtaxSettlementReplay(t *testing.T) {
	if testing.Short() {
	...
	logChaosProof(t, "gtax_settlement_replay", map[string]string{
