...
func DefaultPolicyConfig() PolicyConfig {
	return PolicyConfig{
		TierPass:    campaignmodel.DefaultFraudThresholdPass,
		TierSuspect: campaignmodel.DefaultFraudThresholdSuspect,
		TierIVT:     campaignmodel.DefaultFraudThresholdIVT,
		TierBlock:   campaignmodel.DefaultFraudThresholdBlock,
