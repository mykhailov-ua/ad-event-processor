...
func VerifyJWTResolved(tokenStr string) (*entitlements.LicenseClaims, error) {
...
func VerifyJWTWithKey(tokenStr string, pubKey ed25519.PublicKey) (*entitlements.LicenseClaims, error) {
	if len(pubKey) > 0 {
