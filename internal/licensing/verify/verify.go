...
func DecodeUnverified(tokenStr string) (*entitlements.LicenseClaims, error) {
...
func VerifyJWT(tokenStr string, pubKey ed25519.PublicKey) (*entitlements.LicenseClaims, error) {
