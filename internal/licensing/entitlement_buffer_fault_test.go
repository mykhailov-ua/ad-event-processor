...
func logEntitlementFaultProof(t *testing.T, fault string, fields map[string]string) {
	t.Helper()
	var b []byte
	b = append(b, "fault_proof fault="...)
	b = append(b, fault...)
...
func TestFault_EntitlementBufferOOMProtection(t *testing.T) {
	...
	logEntitlementFaultProof(t, "entitlement_buffer_oom_guard", map[string]string{
		"subsystem": "licensing",
...
func TestFault_EntitlementBufferRecover(t *testing.T) {
	...
	logEntitlementFaultProof(t, "entitlement_buffer_recovery", map[string]string{
		"subsystem": "licensing",
