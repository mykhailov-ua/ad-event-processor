...
//     shadow-diff, reconcile/export (ClickHouse stats + optional live-gate fields).
...
//   - Deal and floor mutations enqueue RELOAD_RTB_CATALOG outbox in the same Postgres transaction as the write.
...
//   - Floor optimizer writes rtb_floor_suggestions Postgres rows and may enqueue catalog reload on apply.
//
// Forbidden:
