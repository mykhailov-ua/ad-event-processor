...
func (s *Service) relayPostbacks(ctx context.Context, campaignID uuid.UUID, clickID string) {
...
func (s *Service) recordWebhookStartEvent(
	ctx context.Context,
