...
type TelegramService interface {
	...
	GetTelegramReport(ctx context.Context, from, to time.Time, filter ReportFilter) ([]byte, error)
	GetTelegramSummaryReport(ctx context.Context, from, to time.Time, filter ReportFilter) ([]byte, error)
	GetTelegramFunnelReport(ctx context.Context, from, to time.Time, filter ReportFilter) ([]byte, error)
	GetTelegramBotsReport(ctx context.Context, from, to time.Time, filter ReportFilter) ([]byte, error)
	GetTelegramPremiumReport(ctx context.Context, from, to time.Time, filter ReportFilter) ([]byte, error)
	GetTelegramFraudReport(ctx context.Context, from, to time.Time, filter ReportFilter) ([]byte, error)
}
...
type HTTPHandlers struct {
	...
	ObserveReport        func(string, http.HandlerFunc) http.HandlerFunc
...
func (h *HTTPHandlers) validateInitData(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) clicksMint(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) webhook(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) createDeeplink(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) getDeeplink(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) listBots(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) getBot(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) configureBot(w http.ResponseWriter, r *http.Request) {
	idStr := r.PathValue("id")
	campaignID, err := uuid.Parse(idStr)
	if err != nil {
		httpresponse.Error(w, http.StatusBadRequest, "BAD_REQUEST", "invalid campaign id")
...
func (h *HTTPHandlers) listPostbacks(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) createPostback(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) updatePostback(w http.ResponseWriter, r *http.Request) {
	idStr := r.PathValue("id")
...
func (h *HTTPHandlers) deletePostback(w http.ResponseWriter, r *http.Request) {
	idStr := r.PathValue("id")
	id, err := uuid.Parse(idStr)
	if err != nil {
		httpresponse.Error(w, http.StatusBadRequest, "BAD_REQUEST", "invalid postback id")
...
func (h *HTTPHandlers) testPostback(w http.ResponseWriter, r *http.Request) {
	idStr := r.PathValue("id")
	id, err := uuid.Parse(idStr)
	if err != nil {
		httpresponse.Error(w, http.StatusBadRequest, "BAD_REQUEST", "invalid postback id")
...
func (h *HTTPHandlers) getTelegramReport(w http.ResponseWriter, r *http.Request) {
	h.writeTelegramReport(w, r, h.Telegram.GetTelegramReport)
}

func (h *HTTPHandlers) getTelegramSummaryReport(w http.ResponseWriter, r *http.Request) {
	h.writeTelegramReport(w, r, h.Telegram.GetTelegramSummaryReport)
}

func (h *HTTPHandlers) getTelegramFunnelReport(w http.ResponseWriter, r *http.Request) {
	h.writeTelegramReport(w, r, h.Telegram.GetTelegramFunnelReport)
}

func (h *HTTPHandlers) getTelegramBotsReport(w http.ResponseWriter, r *http.Request) {
	h.writeTelegramReport(w, r, h.Telegram.GetTelegramBotsReport)
}

func (h *HTTPHandlers) getTelegramPremiumReport(w http.ResponseWriter, r *http.Request) {
	h.writeTelegramReport(w, r, h.Telegram.GetTelegramPremiumReport)
}

func (h *HTTPHandlers) getTelegramFraudReport(w http.ResponseWriter, r *http.Request) {
	h.writeTelegramReport(w, r, h.Telegram.GetTelegramFraudReport)
}

func (h *HTTPHandlers) exportTelegramReport(w http.ResponseWriter, r *http.Request) {
...
type telegramReportFn func(ctx context.Context, from, to time.Time, filter ReportFilter) ([]byte, error)

func (h *HTTPHandlers) writeTelegramReport(w http.ResponseWriter, r *http.Request, fn telegramReportFn) {
...
func parseTelegramReportQuery(w http.ResponseWriter, r *http.Request) (time.Time, time.Time, ReportFilter, bool) {
	q := r.URL.Query()
	fromStr := q.Get("from")
	toStr := q.Get("to")
	...
	if err1 != nil || err2 != nil {
		...
		return time.Time{}, time.Time{}, ReportFilter{}, false
	}
