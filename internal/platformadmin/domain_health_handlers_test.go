...
func (s *stubDomainHealthService) ListDomainHealth(ctx context.Context) ([]platformadmin.DomainHealthDTO, error) {
	return nil, nil
}

func (s *stubDomainHealthService) AddCustomDomain(ctx context.Context, hostname string) (platformadmin.DomainHealthDTO, error) {
	return platformadmin.DomainHealthDTO{}, nil
}
...
func (s *stubDomainHealthService) ProbeDomainNow(ctx context.Context, hostname string) (platformadmin.DomainHealthDTO, error) {
	return platformadmin.DomainHealthDTO{}, nil
}

func (s *stubDomainHealthService) SetupDomainSSL(ctx context.Context, hostname string) (platformadmin.DomainSSLSetupResult, error) {
	return platformadmin.DomainSSLSetupResult{}, nil
}
...
func (s *stubDomainHealthService) ParkDomain(ctx context.Context, req platformadmin.ParkDomainRequest) (platformadmin.ParkDomainResponse, error) {
	return platformadmin.ParkDomainResponse{}, nil
}

func TestDomainHealthTLSAllowed_loopbackAllowed(t *testing.T) {
	h := &platformadmin.DomainHealthHTTPHandlers{
