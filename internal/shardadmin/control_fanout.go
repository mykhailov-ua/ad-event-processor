...
// PublishCampaignControlToAllShards pipelines INCR campaign epoch and PUBLISH per shard (tracker registry reload).
...
// SetNXOnAllShards runs strict fanout; allNew false if any shard already holds the lease key.
