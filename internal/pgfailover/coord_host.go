...
// AppendReplicatedAt: in-memory Postgres failover log offset; ErrReplicationGap on hole (network partition).
...
func (h *CoordHost) CoordGetOrCreatePartition(topic string) (broker.CoordPartition, error) {
	if topic != h.topicKey {
