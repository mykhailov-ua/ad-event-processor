...
func TestFault_PinnedWorkerPoolSaturationSpike(t *testing.T) {
	...
	faultproof.Log(t, "worker_pool_saturation_spike", map[string]string{
...
func TestFault_FraudStreamRingOverflowSpike(t *testing.T) {
	q := NewFraudStreamWriterNearFullForTest("fraud-stream-fault", 1000, 32)
	...
	faultproof.Log(t, "fraud_stream_ring_overflow", map[string]string{
...
func TestFault_TrackUnderWorkerPoolSpike(t *testing.T) {
	...
	stack := startAdsIngestStackOpts(t, infra, "ads-fault-worker-pool-spike", adsIngestStackOpts{
	...
	faultproof.Log(t, "track_worker_pool_spike", map[string]string{
