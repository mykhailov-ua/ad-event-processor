...
func (h *HTTPHandlers) registerHostedEditorRoutes(mux *http.ServeMux, limit func(http.HandlerFunc) http.HandlerFunc, perm func(string, http.HandlerFunc) http.HandlerFunc) {
...
func (h *HTTPHandlers) getHostedEditorState(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) readHostedEditorFile(w http.ResponseWriter, r *http.Request) {
	id, err := coldpath.ParsePathUUID(r, "id")
	if err != nil {
		httpresponse.Error(w, http.StatusBadRequest, "BAD_REQUEST", "invalid lander id")
		return
...
func (h *HTTPHandlers) saveHostedEditorFile(w http.ResponseWriter, r *http.Request) {
	id, err := coldpath.ParsePathUUID(r, "id")
	if err != nil {
		httpresponse.Error(w, http.StatusBadRequest, "BAD_REQUEST", "invalid lander id")
		return
...
func (h *HTTPHandlers) publishHostedDraft(w http.ResponseWriter, r *http.Request) {
	id, err := coldpath.ParsePathUUID(r, "id")
	if err != nil {
		httpresponse.Error(w, http.StatusBadRequest, "BAD_REQUEST", "invalid lander id")
		return
...
func (h *HTTPHandlers) serveHostedPreviewPath(w http.ResponseWriter, r *http.Request) {
	h.serveHostedPreview(w, r, r.PathValue("path"))
}

func (h *HTTPHandlers) serveHostedPreview(w http.ResponseWriter, r *http.Request, relPath string) {
