...
func (h *HTTPHandlers) RegisterHostedLanderRoutes(mux *http.ServeMux) {
...
func (h *HTTPHandlers) uploadHostedLander(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) serveHostedLanderPath(w http.ResponseWriter, r *http.Request) {
	h.serveHostedLander(w, r, r.PathValue("path"))
}

func (h *HTTPHandlers) serveHostedLander(w http.ResponseWriter, r *http.Request, relPath string) {
	if h == nil || h.Service == nil {
		http.NotFound(w, r)
		return
	}
