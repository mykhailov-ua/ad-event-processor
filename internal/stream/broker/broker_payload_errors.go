...
// ErrBrokerPayloadUnrecognized means Fetch payload is neither AdStreamEvent nor AdLogRecord VT.
...
// ErrFraudBrokerSinkConfig means FraudBrokerSink.Produce requires broker addr and topic at wire-up.
