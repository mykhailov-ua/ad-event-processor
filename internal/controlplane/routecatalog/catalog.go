...
var routeCatalog = []Route{
	...
	{Method: "PATCH", Path: "/api/v1/customers/{id}/cost-center"},
	...
	{Method: "POST", Path: "/api/v1/campaigns/bulk-clone"},
	...
	{Method: "GET", Path: "/api/v1/campaigns/{id}/integration-health"},
	{Method: "GET", Path: "/api/v1/campaigns/{id}/geo-summary"},
	{Method: "GET", Path: "/api/v1/campaigns/{id}/fraud-editor"},
	...
	{Method: "PATCH", Path: "/api/v1/brands/{id}"},
	{Method: "DELETE", Path: "/api/v1/brands/{id}"},
	...
	{Method: "GET", Path: "/api/v1/fraud/moderator-corpus"},
	{Method: "POST", Path: "/api/v1/fraud/moderator-corpus"},
	{Method: "POST", Path: "/api/v1/fraud/moderator-corpus/import"},
	{Method: "GET", Path: "/api/v1/fraud/moderator-corpus/preview"},
	...
	{Method: "GET", Path: "/api/v1/domains/cloudflare/zones"},
	{Method: "GET", Path: "/api/v1/flows"},
	{Method: "POST", Path: "/api/v1/flows"},
	{Method: "POST", Path: "/api/v1/flows/validate"},
	{Method: "GET", Path: "/api/v1/flows/{id}"},
	{Method: "PUT", Path: "/api/v1/flows/{id}"},
	{Method: "DELETE", Path: "/api/v1/flows/{id}"},
	{Method: "POST", Path: "/api/v1/flows/{id}/clone"},
	{Method: "GET", Path: "/api/v1/landers"},
	{Method: "POST", Path: "/api/v1/landers"},
	{Method: "GET", Path: "/api/v1/landers/{id}"},
	{Method: "PATCH", Path: "/api/v1/landers/{id}"},
	{Method: "DELETE", Path: "/api/v1/landers/{id}"},
	...
	{Method: "GET", Path: "/api/v1/offers/{id}"},
	{Method: "PATCH", Path: "/api/v1/offers/{id}"},
	{Method: "DELETE", Path: "/api/v1/offers/{id}"},
	{Method: "GET", Path: "/api/v1/ops/domains/tls-allowed"},
	{Method: "POST", Path: "/api/v1/ops/domains/wildcard-ssl"},
	{Method: "POST", Path: "/api/v1/ops/domains/bulk"},
	{Method: "POST", Path: "/api/v1/ops/domains/bulk-ssl"},
	{Method: "GET", Path: "/api/v1/ops/domains/jobs/{job_id}"},
	{Method: "PATCH", Path: "/api/v1/ops/domains/{hostname}/burn"},
	...
	{Method: "GET", Path: "/api/v1/team/metrics"},
	{Method: "GET", Path: "/api/v1/team/budget-approvals/mine"},
	...
	{Method: "POST", Path: "/api/v1/campaigns/{id}/apply-templates/dry-run"},
	...
	{Method: "GET", Path: "/api/v1/postbacks/health"},
	{Method: "GET", Path: "/api/v1/integrations/postbacks/health"},
	{Method: "GET", Path: "/api/v1/integrations/google-sheets/connect"},
	{Method: "GET", Path: "/api/v1/integrations/google-sheets/callback"},
	{Method: "GET", Path: "/api/v1/integrations/google-sheets/status"},
	{Method: "DELETE", Path: "/api/v1/integrations/google-sheets"},
	...
	{Method: "POST", Path: "/api/v1/reports/jobs/{id}/rerun"},
	{Method: "GET", Path: "/api/v1/reports/notifications"},
	{Method: "POST", Path: "/api/v1/reports/notifications/{id}/ack"},
	...
	{Method: "POST", Path: "/api/v1/views/{id}/export"},
	...
	{Method: "POST", Path: "/api/v1/report-schedules/{id}/run"},
