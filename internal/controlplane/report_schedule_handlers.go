...
func (h *ReportsHTTPHandlers) registerReportSchedules(mux *http.ServeMux) {
	if h == nil || h.Pool == nil {
		return
	}
...
func (h *ReportsHTTPHandlers) createReportSchedule(w http.ResponseWriter, r *http.Request) {
...
func (h *ReportsHTTPHandlers) listReportSchedules(w http.ResponseWriter, r *http.Request) {
...
func (h *ReportsHTTPHandlers) getReportSchedule(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
...
func (h *ReportsHTTPHandlers) updateReportSchedule(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
...
func (h *ReportsHTTPHandlers) deleteReportSchedule(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	existing, err := getReportSchedule(r.Context(), h.Pool, id)
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) {
