...
type CryptoBillingWebhookHandlers struct {
...
func (h *CryptoBillingWebhookHandlers) Register(mux *http.ServeMux) {
...
func (h *CryptoBillingWebhookHandlers) handleCryptoWebhook(w http.ResponseWriter, r *http.Request) {
...
func (h *CryptoBillingWebhookHandlers) SecretsConfigured() bool {
	if h == nil {
		return false
	}
