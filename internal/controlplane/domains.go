...
var ManagementDomains = []Domain{
	...
	}, Files: []string{"delivery_types.go", "service_campaign.go", "vpp_controller.go", "vpp_pacing.go"}, LogicFiles: []string{"campaign_validate.go"}, TestPrefixes: []string{"campaign_domain_test", "campaign_pacing_test", "brand_fcap_test", "api_campaigns", "delivery_test", "pacing_controller_test", "cohort_", "vpp_", "flow_"}},
