...
var ManagementDomains = []Domain{
	...
	{ID: "api", Prefixes: []string{"handler_api", "api_"}, Files: []string{
		...
		"support_bundle.go", "support_feedback.go", "dry_run.go",
	}, TestPrefixes: []string{"handler_api", "api_", "dry_run", "support_bundle", "support_feedback"}},
	{ID: "selfserve", Prefixes: []string{"api_selfserve", "handler_selfserve", "service_selfserve", "selfserve_"}, TestPrefixes: []string{"api_selfserve", "handler_selfserve", "selfserve_"}},
