...
var ManagementDomains = []Domain{
	...
	{ID: "campaign", Prefixes: []string{
		...
		"campaign_", "campaigns_handlers", "service_brands", "handler_warm", "service_warm", "drain_",
		"service_pacing", "vpp_", "flow_",
	}, Files: []string{"delivery_types.go", "service_campaign.go", "vpp_controller.go", "vpp_pacing.go", "campaign_runtime_bridge.go", "campaign_worker_bridge.go"}, LogicFiles: []string{"campaign_patch.go", "campaign_publish_gate.go"}, TestPrefixes: []string{"campaign_pacing_test", "brand_fcap_test", "api_campaigns", "delivery_test", "pacing_controller_test", "cohort_", "vpp_", "flow_", "campaign_editor", "campaign_clone", "campaign_wizard"}},
	...
	{ID: "fraud", Prefixes: []string{"service_fraud", "blacklist_", "worker_blacklist_", "fraud_", "ml_blacklist_", "customer_fraud_"}, TestPrefixes: []string{"service_fraud", "blacklist_", "fraud_", "ml_blacklist_", "customer_fraud_"}},
	...
	{ID: "ops", Prefixes: []string{"ops_", "doctor_handlers"}, Files: []string{"ops_readers.go"}, TestPrefixes: []string{"ops_", "doctor_handlers"}},
	...
	{ID: "api", Prefixes: []string{"api", "api_", "reports_", "report_", "filter_reject_", "ch_campaign_"}, Files: []string{
		...
		"list_envelope.go",
		"format_display.go",
	}, TestPrefixes: []string{"api", "api_", "dry_run", "support_bundle", "support_feedback", "reports_", "report_", "format_display", "list_envelope"}},
	{ID: "selfserve", Prefixes: []string{
		...
		"dashboards_", "team_", "publisher_",
	}, TestPrefixes: []string{"api_selfserve", "selfserve_", "buyer_commercial", "dashboards_buyer", "buyer_resolve", "dashboards_", "team_", "publisher_"}},
