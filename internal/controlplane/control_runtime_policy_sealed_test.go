...
func TestControlRuntimePolicy_devModeUsesEmbed(t *testing.T) {
...
func TestControlRuntimePolicy_invalidMCK(t *testing.T) {
	var mck [32]byte
	mck[0] = 1
	...
	_, err = resolveControlRuntimePolicyBytes()
	require.Error(t, err)
}

func TestControlRuntimePolicy_validMCK(t *testing.T) {
	...
	require.NoError(t, InitControlRuntimePolicy())
	...
	require.False(t, ControlLicenseRecheckRequired())
}
