...
func (selfServeTemplatesStub) ListCampaignTemplates(_ context.Context, _ uuid.UUID, _, _ int32) ([]adminapi.CampaignTemplateDTO, int64, error) {
	return nil, 0, nil
}
...
func TestSelfServeCreateCampaign_requiresTemplateID(t *testing.T) {
	h := &adminapi.SelfServeHTTPHandlers{
