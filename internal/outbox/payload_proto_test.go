...
func TestProto_roundTripCampaign(t *testing.T) {
...
func TestProto_legacyJSONCampaign(t *testing.T) {
...
func BenchmarkDecode_CampaignProto(b *testing.B) {
...
func BenchmarkDecode_CampaignJSON(b *testing.B) {
