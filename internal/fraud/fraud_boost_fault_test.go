...
func TestFault_FraudOutboxBackpressure(t *testing.T) {
	...
	faultproof.Log(t, "fraud_outbox_backpressure", map[string]string{
...
func TestFault_FraudExactlyOnce(t *testing.T) {
	...
	faultproof.Log(t, "fraud_exactly_once", map[string]string{
		"subsystem":     "fraud_scoring",
		"goroutines":    "20",
		"enqueue_calls": "1",
		"exactly_once":  "true",
...
func TestFault_FraudManagementRetry(t *testing.T) {
	...
	faultproof.Log(t, "fraud_management_retry", map[string]string{
		"subsystem":     "fraud_scoring",
		"retry_ok":      "true",
		"enqueue_calls": "1",
		"exactly_once":  "true",
