...
func insertResidentialIntelClickHouse(ctx context.Context, conn driver.Conn, ip string, result ResidentialIntelResult, provider string, cachedAt time.Time) error {
	if conn == nil {
		return nil
	}
