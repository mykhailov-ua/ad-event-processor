...
type mlSnapshotTestHost struct{}

func (h mlSnapshotTestHost) SnapshotPool() *pgxpool.Pool {
	return nil
}

func (h mlSnapshotTestHost) SnapshotRedisShards() []redis.UniversalClient {
	return nil
}
...
func TestFraudMLSnapshotDTOFields(t *testing.T) {
	...
	snap, err := BuildFraudMLSnapshot(t.Context(), mlSnapshotTestHost{})
