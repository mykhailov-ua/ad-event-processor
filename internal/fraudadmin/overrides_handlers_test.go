...
type fraudOverridesStub struct {
	...
	lastReq    fraudadmin.FraudOverrideRequest
	called     bool
}

func (s *fraudOverridesStub) ApplyFraudScoringOverrideForCustomer(_ context.Context, customerID uuid.UUID, req fraudadmin.FraudOverrideRequest) error {
...
func newFraudOverridesHandlers(stub *fraudOverridesStub) *fraudadmin.HTTPHandlers {
