...
func TestGMABaseline_productScopeGates(t *testing.T) {
	const (
...
func TestGMABaseline_tlsTableHarness_ready(t *testing.T) {
...
func TestGMABaseline_linkSigner_roundTrip(t *testing.T) {
	secret := []byte("gma-test-secret")
...
func TestGMABaseline_connTypePolicy_defaults(t *testing.T) {
