...
func (h *AdsPacketHandler) reactTelegramBid(req parsedHTTPRequest, c gnet.Conn, ctx *connContext) gnet.Action {
	...
	body = appendTelegramClickLink(body, baseURL, uid, clickID, parsedReq.widgetID)
