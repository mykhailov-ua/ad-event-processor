...
var fraudReasonCategoryTable = map[string]fraudCategoryMeta{
	...
	"crowd_probe_behavior":       {fraudCategoryAutomated, "Automated traffic"},
	"crowd_probe_timing":         {fraudCategoryAutomated, "Automated traffic"},
	"crowd_probe_asn":            {fraudCategoryAutomated, "Automated traffic"},
	...
	"tcp_syn_opt_mismatch":       {fraudCategoryProxyDatacenter, "Proxy or datacenter traffic"},
	"h2_frame_trace_mismatch":    {fraudCategoryInvalidDevice, "Invalid device signals"},
