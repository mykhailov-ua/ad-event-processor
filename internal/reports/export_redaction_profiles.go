...
func customerFraudByTypeCSVRow(row CustomerFraudByTypeRowDTO) []string {
	return []string{
		row.CampaignID,
		row.FraudCategory,
...
func customerFraudByDimensionCSVRow(row CustomerFraudByDimensionRowDTO) []string {
	return []string{
		row.DimensionValue,
		row.CampaignID,
...
func writeCustomerFraudByTypeExport(w *csv.Writer, profile string, rows []CustomerFraudByTypeRowDTO) error {
...
func writeCustomerFraudByDimensionExport(w *csv.Writer, profile string, rows []CustomerFraudByDimensionRowDTO) error {
...
func exportDeploymentID() string {
	if ExportDeploymentID != nil {
		return strings.TrimSpace(ExportDeploymentID())
	}
	return ""
}
