...
//
// Topology:
//   - reportjob.ReportJobRunner calls reports.WriteReportExport with ReportExportDeps (pool, ClickHouse query, HMAC secret).
...
//
// Invariants:
//   - Non-portfolio exports require ClickHouseQuery; campaign-overview and customer-portfolio may omit ClickHouse.
