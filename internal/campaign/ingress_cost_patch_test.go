...
type ingressCostPatchFX struct{}

func (f ingressCostPatchFX) PublishCampaignUpdate(context.Context, string) {}

func TestApplyIngressCostPatch_roundTrip(t *testing.T) {
	if testing.Short() {
	...
	err = ApplyIngressCostPatch(ctx, ingressCostPatchFX{}, pool, campID, IngressCostConfigDTO{
		Param:    "cost",
		Scale:    "decimal",
		MaxMicro: 5_000_000,
		Policy:   "ignore",
