...
func TestPinnedBlocklistOpensAfterPin(t *testing.T) {
	...
	pinDir := filepath.Join(DefaultBPFPinDir, "pin-dir-smoke-"+strconv.Itoa(os.Getpid()))
	...
	blocklistPath := filepath.Join(pinDir, MapBlocklistV4)
