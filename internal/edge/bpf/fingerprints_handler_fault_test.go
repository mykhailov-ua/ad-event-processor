...
func TestFault_FingerprintHandlerBrokenSamples(t *testing.T) {
	...
	testutil.LogFaultProof(t, "fingerprint_handler_broken_samples", map[string]string{
...
func TestFault_FingerprintHandlerConcurrentDecode(t *testing.T) {
	const goroutines = 32
	const perG = 200
	...
	testutil.LogFaultProof(t, "fingerprint_handler_concurrent_decode", map[string]string{
...
func TestFault_FingerprintHandlerCallbackFailure(t *testing.T) {
	const failAfter = 7
	...
	testutil.LogFaultProof(t, "fingerprint_handler_callback_failure", map[string]string{
...
func TestFault_FingerprintDecodeOverflowFields(t *testing.T) {
	...
	testutil.LogFaultProof(t, "fingerprint_decode_overflow_fields", map[string]string{
		"tcp_hash": "ffffffff",
		"ts_ns":    "max_uint64",
	})
}
