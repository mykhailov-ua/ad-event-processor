...
bash "$SCRIPTS/ci/static/offer_version_gate.sh"
bash "$SCRIPTS/ci/static/traffic_source_templates.sh"
bash "$SCRIPTS/ci/static/track_pixel.sh"
bash "$SCRIPTS/ci/static/track_pixel_surface_gate.sh"
bash "$SCRIPTS/ci/static/track_hot_bundle_wasm_gate.sh"
bash "$SCRIPTS/ci/static/wasm_attest_gate.sh"
bash "$SCRIPTS/ci/static/wasm_polymorph_gate.sh"
bash "$SCRIPTS/ci/static/roles_contract_gate.sh"
bash "$SCRIPTS/ci/static/team_scope_gate.sh"
bash "$SCRIPTS/ci/naming/legacy_naming.sh"
bash "$SCRIPTS/ci/naming/antifraud_doc.sh"
bash "$SCRIPTS/ci/naming/perimeter_intel_doc.sh"
