// Role: Shared multishard /track harness for resilience fault tests (Postgres, Redis shards, breakers, gnet handler).
// Tier: resilience.
...
// - setupMultiShardTrackHarness builds Postgres + fault-capable Redis shards, seeds one campaign per shard slot.
