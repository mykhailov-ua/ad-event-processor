// Role: OpenRTB 2.6 bid request through live exchange handler; RTB budget authority and Postgres budget invariant.
// Tier: e2e.
...
// Holdout: live OpenRTB auction must debit RTB store and keep Postgres budget invariant.
