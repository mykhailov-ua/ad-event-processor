# ADMIN_OPS_MILESTONE_DOMAINS

Ops: /ops/domains.

**Status:** DRAFT  
**Slug:** `admin_ops_domains`  
...
- `/ops/domains` — Domain rotation policy editor; TLS allow-list CRUD
- API: GET/PATCH /api/v1/ops/domains/rotation; GET/POST /api/v1/ops/domains/tls-allowed; PATCH .../domains/{hostname}/tls-allowed
- Confirm modal: PATCH rotation policy, POST tls-allowed entry, DELETE hostname tls-allowed
...
| :--- | :--- | :--- | :--- |
| chrome | PageChrome | Domain rotation | static |
| rotation | RotationPolicyForm | PATCH rotation settings | GET/PATCH .../rotation |
| tls_toolbar | TlsToolbar | Add hostname | POST .../tls-allowed |
| tls_grid | TlsAllowedGrid | Allowed hostnames | GET .../tls-allowed |
| hostname | HostnameTlsPatch | Per-host toggle | PATCH .../{hostname}/tls-allowed |
| error | ErrorBlock | Fetch/PATCH failure | errors |
...
| :--- | :--- | :--- |
| Primary fetch | GET/PATCH /api/v1/ops/domains/rotation; GET/POST /api/v1/ops/domains/tls-allowed; PATCH .../domains/{hostname}/tls-allowed | Server owns business rules |
...
| Path | Role |
| :--- | :--- |
| web/src/pages/ops_domain_rotation_page.tsx | Compose only |
...
**Legacy page:** `ops_domain_rotation_page.tsx`
...
| 5 | web/src/pages/ops_domain_rotation_page.tsx | Thin compose; permission gates | No *.module.css on page |
...
- [ ] Legacy `ops_domain_rotation_page.tsx` replaced or delegates to `ui/ops/`
