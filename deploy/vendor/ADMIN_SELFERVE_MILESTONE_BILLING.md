# ADMIN_SELFERVE_MILESTONE_BILLING

Statement summary, invoices list, payment intent create

**Status:** DRAFT  
**Slug:** `admin_selfserve_billing`  
...
- `/selfserve/billing` — Statement summary, invoices list, payment intent create
- API: GET /api/v1/selfserve/billing/statement; GET /api/v1/selfserve/invoices; POST .../payment-intents
...
| :--- | :--- | :--- | :--- |
| chrome | PageChrome | Billing | static |
| statement | BillingStatement | current period summary | billing/statement |
| invoices | InvoicesGrid | invoice rows | selfserve/invoices |
| payment | PaymentIntentForm | top-up intent | payment-intents POST |
| empty | EmptyState | No invoices | items.length===0 |
...
| :--- | :--- | :--- |
| Primary fetch | GET /api/v1/selfserve/billing/statement; GET /api/v1/selfserve/invoices; POST .../payment-intents | Server owns business rules |
...
| Path | Role |
| :--- | :--- |
| web/src/pages/selfserve_billing_page.tsx | Compose |
...
**Legacy page:** `selfserve_billing_page.tsx`
...
- [ ] Legacy `selfserve_billing_page.tsx` replaced or delegates to `ui/selfserve/`
