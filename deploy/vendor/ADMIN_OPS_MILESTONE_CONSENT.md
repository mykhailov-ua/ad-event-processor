# ADMIN_OPS_MILESTONE_CONSENT

Ops: /ops/consent.

**Status:** DRAFT  
**Slug:** `admin_ops_consent`  
...
- `/ops/consent` — GDPR consent proof audit log
- API: GET /api/v1/ops/consent/proofs
...
| :--- | :--- | :--- | :--- |
| chrome | PageChrome | Consent proofs | static |
| toolbar | ConsentToolbar | Export if API supports | permissions |
| grid | ConsentProofGrid | Proof audit rows | opsConsentProofs payload |
| footer | PaginationBar | When API paginates | envelope |
| empty | EmptyState | No proofs in range | empty payload |
...
| :--- | :--- | :--- |
| Primary fetch | GET /api/v1/ops/consent/proofs | Server owns business rules |
...
| Path | Role |
| :--- | :--- |
| web/src/pages/ops_consent_page.tsx | Compose only |
...
**Legacy page:** `ops_consent_page.tsx`
...
| 5 | web/src/pages/ops_consent_page.tsx | Thin compose; permission gates | No *.module.css on page |
...
- [ ] Legacy `ops_consent_page.tsx` replaced or delegates to `ui/ops/`
