# ADMIN_SELFERVE_MILESTONE_CREATE

Quick campaign create wizard from templates

**Status:** DRAFT  
**Slug:** `admin_selfserve_create`  
...
- `/selfserve/campaigns/new` — Quick campaign create wizard from templates
- API: GET /api/v1/selfserve/templates; POST /api/v1/selfserve/campaigns
...
| :--- | :--- | :--- | :--- |
| chrome | PageChrome | New campaign | static |
| templates | TemplatePicker | onboarding templates | selfserve/templates |
| wizard | CampaignCreateWizard | multi-step create | POST selfserve/campaigns |
| toolbar | WizardNav | Back / Next / Create | wizard step |
| summary | CreateSummary | Review before POST | wizard draft |
| error | ErrorBlock | Create failure | errors |
...
| :--- | :--- | :--- |
| Primary fetch | GET /api/v1/selfserve/templates; POST /api/v1/selfserve/campaigns | Server owns business rules |
...
| Path | Role |
| :--- | :--- |
| web/src/pages/selfserve_campaign_create_page.tsx | Compose |
...
**Legacy page:** `selfserve_campaign_create_page.tsx`
...
- [ ] Legacy `selfserve_campaign_create_page.tsx` replaced or delegates to `ui/selfserve/`
