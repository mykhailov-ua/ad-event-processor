...
Controlplane file consolidation: `operation_lease.go`, `outbox.go`, `recon.go`, `api.go`, `node_scorer.go`, `ops.go`/`ops_readers.go`, `service_platform.go`, `quota.go`, `shard_control.go`; adminapi reports/billing/wire merged.
