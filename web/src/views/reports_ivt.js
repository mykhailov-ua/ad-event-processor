    ...
    replaceChildren(container,
      ...
      el('form', {
        ...
        renderFormField({
          label: 'From',
          htmlFor: 'ivt-from',
          children: el('input', { id: 'ivt-from', className: 'form-input', value: from, onInput: (e) => { from = e.target.value; } }),
        }),
        renderFormField({
          label: 'To',
          htmlFor: 'ivt-to',
          children: el('input', { id: 'ivt-to', className: 'form-input', value: to, onInput: (e) => { to = e.target.value; } }),
        }),
