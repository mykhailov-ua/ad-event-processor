    ...
    replaceChildren(container,
      ...
      el('form', {
        ...
        renderFormField({
          label: 'From',
          htmlFor: 'geo-from',
          children: el('input', { id: 'geo-from', className: 'form-input', value: from, onInput: (e: Event) => { from = eventTargetValue(e); } }),
        }),
        renderFormField({
          label: 'To',
          htmlFor: 'geo-to',
          children: el('input', { id: 'geo-to', className: 'form-input', value: rangeTo, onInput: (e: Event) => { rangeTo = eventTargetValue(e); } }),
        }),
