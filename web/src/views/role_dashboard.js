...
export function mount(container, ctx) {
   ...
   *
   * @param {Array<{ id: string, status: string }>} jobs
   */
  function syncExportJobState(jobs) {
  ...
  function renderAdOps() {
    ...
    return el('div', { className: 'stack stack--lg section-block' },
      ...
      renderSubsection('Worst sources',
        worst.length === 0
          ? el('p', { className: 'empty-hint' }, 'No quality flags from placements data.')
          : el('div', { className: 'table-wrapper' },
            el('table', { className: 'data-table' },
              el('thead', null,
                el('tr', null,
              ...
              el('tbody', null,
                worst.map((s) => {
                  ...
                  return el('tr', null,
                    ...
                    el('td', null, el('a', { href: placementsHref, className: 'btn btn--ghost btn--sm' }, 'Placements')),
                  );
                }),
              ),
            ),
  ...
  function renderFraud() {
    ...
    return el('div', { className: 'stack stack--lg section-block', 'data-testid': 'fraud-dashboard' },
      ...
      renderSubsection('Geo suggestions (read-only)',
        geoHints.length === 0
          ? el('p', { className: 'empty-hint' }, 'No high-IVT countries in the last 7 days.')
          : el('div', { className: 'table-wrapper' },
            el('table', { className: 'data-table' },
              el('thead', null,
                el('tr', null,
      ...
      renderSubsection('Manual labels queue',
        recentLabels.length === 0
          ? el('p', { className: 'empty-hint' }, 'No manual labels in queue.')
          : el('div', { className: 'table-wrapper' },
            el('table', { className: 'data-table' },
              el('thead', null,
                el('tr', null,
