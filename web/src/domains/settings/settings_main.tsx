...
import { formatRestartRequiredLabels } from '@/domains/settings/settings_field_labels';
      ...
      <div className={cn('grid', adminSpacing.gap.xl)}>
        ...
        {draftDirty || restartLabels.length > 0 ? (
          <p className={adminTypography.bodyMuted} role="note">
            Changes are saved to the control plane. Write to disk and restart services to apply on
            the tracker.
          </p>
        ) : null}
