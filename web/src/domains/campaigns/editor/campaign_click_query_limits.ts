...
export const CAMPAIGN_EDITOR_MONO_EXTRALIGHT_CLASS = 'ui-editor-mono-extralight';

/** JetBrains Mono wght 200 for campaign editor code/UUID/URL fields. */
export const CAMPAIGN_CLICK_QUERY_PARAMS_TEXTAREA_MONO_CLASS = CAMPAIGN_EDITOR_MONO_EXTRALIGHT_CLASS;

export const CAMPAIGN_CLICK_QUERY_PARAMS_FIELD_HINT =
  `Whole JSON up to ${CAMPAIGN_CLICK_QUERY_PARAMS_JSON_MAX_CHARS.toLocaleString()} characters. Up to ${CAMPAIGN_CLICK_QUERY_PARAM_MAX_KEYS} keys; each value max ${CAMPAIGN_CLICK_QUERY_PARAM_MAX_VALUE_LEN} characters.`;
