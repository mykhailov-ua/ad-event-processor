...
import { CollapsibleSection } from '@/shell/collapsible_section';
      ...
      <CreativeDirectoryStack>
        ...
        {onSaveFlow ? (
          <section className="grid gap-4">
            <h2 className={adminTypography.sectionTitle}>Stream editor</h2>
        ...
        <section className="grid gap-2">
          <h2 className={adminTypography.sectionTitle}>Metadata</h2>
          <dl className={cn('grid gap-1', adminTypography.body)}>
            <div>
              <dt className="text-muted-foreground">Flow ID</dt>
              <dd className={adminTypography.captionPlain}>{flow.id}</dd>
            </div>
            <div>
