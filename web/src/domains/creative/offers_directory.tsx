        ...
        <div aria-atomic="true" aria-live="polite">
          {(items ?? []).length === 0 ? (
            ...
            <TableHost className="w-full">
              ...
              >
                <colgroup>
                  <col className={OFFER_COLUMN_WIDTHS.name} />
                  <col className={OFFER_COLUMN_WIDTHS.url} />
                  <col className={OFFER_COLUMN_WIDTHS.created} />
                  <col className={OFFER_COLUMN_WIDTHS.actions} />
                </colgroup>
                <TableHeader>
                  <tr>
