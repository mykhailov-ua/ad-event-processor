...
const ConfirmDialog = lazy(() => import('./confirm_dialog.js').then((mod) => ({
  default: mod.ConfirmDialog,
})));

/**
 * Global confirm dialog host for apiConfirmed / requestConfirm.
 */
export function ConfirmProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    setConfirmHandler((req) => new Promise<boolean>((resolve) => {
