/** Go: DataFreshness on report/dashboard envelopes. */
...
/** Shared report list envelope (placements, keywords, extended rows, …). */
...
/** Loose report row — column keys vary by endpoint. */
