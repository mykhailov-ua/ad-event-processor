...
import type { useTelegramReport } from '../helpers/use_telegram_report.js';
    ...
    <>
      ...
      >
        ...
        <div className="toolbar-row">
          ...
          {exportStatus ? <span className="text-muted text-sm">{exportStatus}</span> : null}
        </div>
      </form>
...
export function TelegramReportEmpty() {
  ...
  return (
    <div className="empty-state section-block">
      ...
      {copy.actionHref ? (
        <ButtonLink href={copy.actionHref} label={copy.actionLabel ?? 'Open'} variant="secondary" />
      ) : null}
    </div>
  );
}
