...
export function ReportsHubPage() {
  ...
  const loadProbes = useCallback(async () => {
    const keys = REPORT_CATALOG.filter((c) => !c.live && !c.retired).map((c) => c.key);
    if (keys.length === 0) {
      setProbing(false);
      return;
    }
    ...
    <>
      ...
      <section className="settings-panel">
        <div className="settings-panel__header">
          ...
          <p className="settings-panel__desc">
            Live reports are queryable today. Planned reports may return stub data until the API
            ships.
          </p>
        </div>
            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="reports-hub__actions-cell">
                    Actions
                  </th>
                </tr>
              </thead>
                      ...
                      <td>
                        ...
                        >
                          <Icon
                            ...
                            size={14}
                            className="reports-hub__link-icon"
                          />
                          {card.title}
                        </a>
                      </td>
