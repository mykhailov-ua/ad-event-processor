...
const registry = new Map<string, ConfirmEntry>([
  ...
  ['POST /campaigns/bulk', { level: 'destructive', label: 'Bulk pause or resume campaigns' }],
  ['POST /landers', { level: 'standard', label: 'Create lander' }],
  ['POST /offers', { level: 'standard', label: 'Create offer' }],
  ['POST /flows', { level: 'standard', label: 'Create flow' }],
  ['POST /landers/{id}/hosted-upload', { level: 'standard', label: 'Upload hosted lander ZIP' }],
  ...
  ['POST /reports/jobs', { level: 'standard', label: 'Export report' }],
  ...
  ['POST /automation/rules', { level: 'standard', label: 'Create automation rule' }],
  ['PUT /automation/rules/{id}', { level: 'standard', label: 'Update automation rule' }],
  ['DELETE /automation/rules/{id}', { level: 'destructive', label: 'Delete automation rule' }],
  ['POST /automation/rules/{id}/dry-run', { level: 'none' }],
  ...
  ['POST /license/apply', { level: 'strong', label: 'Apply license JWT' }],
  ['POST /report-schedules', { level: 'standard', label: 'Create report schedule' }],
  ['PUT /report-schedules/{id}', { level: 'standard', label: 'Update report schedule' }],
  ['DELETE /report-schedules/{id}', { level: 'destructive', label: 'Delete report schedule' }],
