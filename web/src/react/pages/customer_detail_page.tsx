...
import { createSortState, sortRows, toggleSort } from '../../ui/data_table.js';
import { mountCustomerApiKeysPanel } from '../../panels/customer_api_keys_panel.js';
...
export function CustomerDetailPage() {
  ...
  const mountApiKeys = useCallback(
    (host: HTMLElement) => mountCustomerApiKeysPanel(host, { canCreate: canCreateApiKey }),
    [canCreateApiKey],
  );
  ...
  return (
    <>
      ...
      <LegacyPanelHost active mount={mountApiKeys} deps={[id]} />
