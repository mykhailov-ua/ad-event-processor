...
/**
 * Post-install checklist after platform bootstrap.
 */
      ...
      <div className="login-box login-box--narrow">
        ...
        {clickExample ? (
          <p className="text-sm mt-3">
            Sample click:{' '}
            <a href={clickExample} className="link">{clickExample}</a>
          </p>
        ) : null}
