...
export const uiSurfaces = {
  ...
  panel: 'grid gap-3 rounded-[8px] border border-border bg-card p-4 text-card-foreground shadow-none',
  control:
  ...
  chip:
    'inline-flex min-h-7 max-w-full shrink-0 items-center justify-center gap-1.5 whitespace-nowrap border border-border px-3 py-1 text-xs font-semibold leading-[18px] shadow-none transition-colors',
