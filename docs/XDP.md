...
**Parser security boundary:** XDP is **out of scope** for [PARSER.md](PARSER.md) (no HTTP/JSON parse). See section 8.3 there.

See: [ARCHITECTURE.md](ARCHITECTURE.md) section 11, [ARCHITECTURE.md](ARCHITECTURE.md) section 1.
...
- Bench reference: `go test ./internal/edge/ -bench='BenchmarkXDP_' -benchmem` (dev/lab only; harness `xdp_prog_test`, not kernel RX).
